...
- [x] 4.1 Add a dedicated GitHub Actions workflow that builds the site, uploads the Pages artifact, and deploys it on pushes to `github-pages` and manual dispatch.
