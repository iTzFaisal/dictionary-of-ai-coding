...
- [x] 4.1 Add a dedicated GitHub Actions workflow that builds the site, uploads the Pages artifact, and deploys it on pushes to `main`, `github-pages`, and manual dispatch.
...
- [x] 4.4 Run type checks and production builds, then manually verify the deployed index, a direct term URL, search, internal links, and mobile navigation.
